...
mongoose.Error.messages.Number.min = "O valor '{VALUE}', atributo '{PATH}' informado é menor que o limite mínimo de '{MIN}'."
mongoose.Error.messages.Number.max = "O valor '{VALUE}', atributo '{PATH}' informado é maior que o limite máximo de '{MAX}'."
